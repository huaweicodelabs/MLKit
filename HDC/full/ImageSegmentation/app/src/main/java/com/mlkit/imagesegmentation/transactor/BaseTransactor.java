...
package com.mlkit.imagesegmentation.transactor;
...
import com.mlkit.imagesegmentation.camera.CameraConfiguration;
import com.mlkit.imagesegmentation.camera.FrameMetadata;
import com.mlkit.imagesegmentation.overlay.GraphicOverlay;
import com.mlkit.imagesegmentation.util.BitmapUtils;
import com.mlkit.imagesegmentation.util.NV21ToBitmapConverters;
...
public abstract class BaseTransactor<T> implements ImageTransactor {
    ...
    private NV21ToBitmapConverters converter = null;
    ...
    public BaseTransactor(Context context) {
        ...
        this.converter = new NV21ToBitmapConverters(this.mContext);
    }
