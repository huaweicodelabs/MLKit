...
package com.mlkit.facedemo.camera;
...
public class CameraConfiguration {
    ...
    static int cameraFacing = CameraConfiguration.CAMERA_FACING_BACK;
    ...
    public static synchronized void setCameraFacing(int facing) {
