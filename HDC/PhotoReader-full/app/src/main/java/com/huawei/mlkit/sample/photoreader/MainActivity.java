...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String[] SOURCE_LANGUAGE_CODE = new String[]{"ZH", "EN"};
    private static final String[] DEST_LANGUAGE_CODE = new String[]{"EN", "ZH"};
    private static final List<String> SP_SOURCE_LIST = new ArrayList<>(Arrays.asList("中文", "英文"));
    private static final List<String> SP_SOURCE_LIST_EN = new ArrayList<>(Arrays.asList("Chinese", "English"));
    private static final List<String> SP_DEST_LIST = new ArrayList<>(Arrays.asList("英文", "中文"));
    private static final List<String> SP_DEST_LIST_EN = new ArrayList<>(Arrays.asList("English", "Chinese"));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.createSpinner();
        btnPhoto = this.findViewById(R.id.btn_photo);
