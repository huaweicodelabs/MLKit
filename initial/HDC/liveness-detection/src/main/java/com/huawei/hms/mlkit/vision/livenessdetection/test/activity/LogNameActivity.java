...
public class LogNameActivity extends Activity {
    public static final String KEY_1 = "key1";
    public static final String KEY_2 = "key2";
    public static final String KEY_3 = "key3";
    private static final String TAG = "LogNameActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            String key3 = intent.getStringExtra(KEY_3);
            Log.i(TAG, "key1: " + key1);
            Log.i(TAG, "key2: " + key2);
            Log.i(TAG, "key3: " + key3);
        }
        ...
        // 把日志文件路径映射到uri，回调给会员中心，核心的操作在fileToGrantUri方法里。
        Intent data = new Intent();
        LogUtils.fileToGrantUriSingle(this, data);
