 ...
 */
public class MaskingFaceView extends View {
    private static final String TAG = MaskingFaceView.class.getSimpleName();

    public static final float SURFACE_HEIGHT = 1000f;
    public static final float SURFACE_RATIO = 0.75f;
    public static final float WIDTH_SPACE_RATIO = 0.346f;
    ...
    public static final int COLOR_BG = Color.parseColor("#DEFFFFFF");
    ...
    public MaskingFaceView(Context context) {
        this(context, null);
    }

    public MaskingFaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(mX, mY, mR + CIRCLE_SPACE, mBGPaint);
    }
