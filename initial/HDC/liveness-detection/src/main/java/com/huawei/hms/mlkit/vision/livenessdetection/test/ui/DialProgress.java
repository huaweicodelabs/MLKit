...
public class DialProgress extends View {
    ...
    private void initConfig(Context context, AttributeSet attrs) {
        ...
        mMaxValue = typedArray.getFloat(R.styleable.DialProgress_maxValue, CircleProgressConstant.DEFAULT_MAX_VALUE);
        mValue = typedArray.getFloat(R.styleable.DialProgress_value, CircleProgressConstant.DEFAULT_VALUE);
        mValueSize =
                typedArray.getDimension(R.styleable.DialProgress_valueSize, CircleProgressConstant.DEFAULT_VALUE_SIZE);
        ...
        mPrecisionFormat = CircleProgressUtil.getPrecisionFormat(precision);
        ...
        mUnitSize =
                typedArray.getDimension(R.styleable.DialProgress_unitSize, CircleProgressConstant.DEFAULT_UNIT_SIZE);
        ...
        mHintSize =
                typedArray.getDimension(R.styleable.DialProgress_hintSize, CircleProgressConstant.DEFAULT_HINT_SIZE);

        mArcWidth =
                typedArray.getDimension(R.styleable.DialProgress_arcWidth, CircleProgressConstant.DEFAULT_ARC_WIDTH);

        mStartAngle =
                typedArray.getFloat(R.styleable.DialProgress_startAngle, CircleProgressConstant.DEFAULT_START_ANGLE);
        mSweepAngle =
                typedArray.getFloat(R.styleable.DialProgress_sweepAngle, CircleProgressConstant.DEFAULT_SWEEP_ANGLE);

        mAnimTime = typedArray.getInt(R.styleable.DialProgress_animTime, CircleProgressConstant.DEFAULT_ANIM_TIME);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int minSize =
                Math.min(
                        getMeasuredWidth() - getPaddingLeft() - getPaddingRight() - 2 * (int) mArcWidth,
    ...
    private float getBaselineOffsetFromY(Paint paint) {
        return CircleProgressUtil.measureTextHeight(paint) / 2;
    }
                ...
                new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public void onAnimationUpdate(ValueAnimator animation) {
                        ...
                        if (BuildConfig.DEBUG) {
                            Log.d(
                                    TAG,
                                    "onAnimationUpdate: percent = "
                                            + mPercent
                                            + ";currentAngle = "
                                            + (mSweepAngle * mPercent)
                                            + ";value = "
                                            + mValue);
                        }
                        invalidate();
